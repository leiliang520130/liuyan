...
function dTree(objName) {
	...
	this.icon = {
		root				: img_url+'img/base.gif',
		folder			: img_url+'img/folder.gif',
		folderOpen	: img_url+'img/folderopen.gif',
		node				: img_url+'img/page.gif',
		empty				: img_url+'img/empty.gif',
		line				: img_url+'img/line.gif',
		join				: img_url+'img/join.gif',
		joinBottom	: img_url+'img/joinbottom.gif',
		plus				: img_url+'img/plus.gif',
		plusBottom	: img_url+'img/plusbottom.gif',
		minus				: img_url+'img/minus.gif',
		minusBottom	: img_url+'img/minusbottom.gif',
		nlPlus			: img_url+'img/nolines_plus.gif',
		nlMinus			: img_url+'img/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
