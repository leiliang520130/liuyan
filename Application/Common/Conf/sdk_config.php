...
//定义回调URL通用的URL
define('URL_CALLBACK', 'http://' . $_SERVER['SERVER_NAME'] . '/index.php/Public/callback');
...
return array(
    ...
    //腾讯QQ登录配置
    'THINK_SDK_QQ' => array(
        'APP_KEY' => '101390932', //应用注册成功后分配的 APP ID
        'APP_SECRET' => '97178b95ba1e1700b579e3879001dcec', //应用注册成功后分配的KEY
    ...
    'THINK_SDK_SINA' => array(
        'APP_KEY' => '3807008683', //应用注册成功后分配的 APP ID
        'APP_SECRET' => 'e9d1fb3c8872fd0d3240aae6bdd61fe2', //应用注册成功后分配的KEY
